...
public class TestObjectsInstances {
    ...
    private TestObjectsInstances() {
        ...
        user.setEmail("jowblow" + (new Random()).nextInt(500) + "@gf.coa");
        user.setFirstName("Bobby");
        user.setLastName("JowBlow");
        ...
        userAlert = new UserAlert();
        userAlert.setId("tempIdForTestinBecauseServerDoesntseemToAutoGenereteOnPost" + random.nextInt(1000));
