...
import com.example.payne.simpletestapp.server.requests.GetRequest;
...
import static com.example.payne.simpletestapp.appUtils.AppConfig.REQUEST_TIME_TRESHOLD;
import static com.example.payne.simpletestapp.appUtils.AppTag.SERVER_HANDLE;
import static com.example.payne.simpletestapp.appUtils.AppTag.STORAGE;
    ...
    public static class FetchBasicAlert {
        ...
        public void begin(IAcclimateAlertFetch fetchingActivity) {
            ...
            try {
                ...
                Log.i(STORAGE,
                        "is old ? = " + (Calendar.getInstance().getTimeInMillis() - wrapper.getLastRequestTime() > REQUEST_TIME_TRESHOLD));
                ...
                if (wrapper.isOld()) {
                    ...
                    Log.i(STORAGE,
                            "last save = " + wrapper.getLastRequestTime());
