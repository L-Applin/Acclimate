...
import com.example.payne.simpletestapp.activities.alertForm.NewAlertFormActivity;
...
import com.example.payne.simpletestapp.appUtils.Callback;
...
import static com.example.payne.simpletestapp.appUtils.AppTag.SERVER_PATCH;
...
public class UserInfoWindow extends PinInfoWindow implements VoteKarma {
    ...
    public void onRequestReceived(Map response){
        ...
        Toast.makeText(displayer.getContext(), "DEBUG : requête effectuée avec succès",
