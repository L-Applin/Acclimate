...
import com.example.payne.simpletestapp.alerts.AlertTypes;
...
import com.example.payne.simpletestapp.map.infoWindow.BasicInfoWindow;
import com.example.payne.simpletestapp.map.infoWindow.UserInfoWindow;
...
import static com.example.payne.simpletestapp.appUtils.AppTag.ALERT_EARTH_FILTER;
import static com.example.payne.simpletestapp.appUtils.AppTag.ALERT_FIRE_FILTER;
import static com.example.payne.simpletestapp.appUtils.AppTag.ALERT_HISTO_FILTER;
import static com.example.payne.simpletestapp.appUtils.AppTag.ALERT_USER_COPY_FILTER;
import static com.example.payne.simpletestapp.appUtils.AppTag.ALERT_USER_FILTER;
import static com.example.payne.simpletestapp.appUtils.AppTag.ALERT_WATER_FILTER;
import static com.example.payne.simpletestapp.appUtils.AppTag.ALERT_WIND_FILTER;
...
public class PinController implements SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     *                  {@link com.example.payne.simpletestapp.map.infoWindow.PinInfoWindow}
     ...
     *                  {@link com.example.payne.simpletestapp.map.infoWindow.BasicInfoWindow}
     *                  that is automatically created with each new pin. This information can
     *                  be accessed by a user with a single tap on the {@link UserPin}.
