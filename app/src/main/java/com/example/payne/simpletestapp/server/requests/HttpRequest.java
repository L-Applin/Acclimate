...
import com.example.payne.simpletestapp.server.requests.exceptions.FailureCause;
import com.example.payne.simpletestapp.server.requests.exceptions.RequestErrorException;
import com.example.payne.simpletestapp.server.requests.exceptions.SmallBodyError;
...
import static com.example.payne.simpletestapp.appUtils.AppTag.AUTH_HEADERS;
import static com.example.payne.simpletestapp.appUtils.AppTag.SERVER;
import static com.example.payne.simpletestapp.appUtils.AppTag.TEST_AUTH;
import static com.example.payne.simpletestapp.server.Server.BASE_SERVER_ADDRESS;
 ...
 * {@link User}, {@link com.example.payne.simpletestapp.monitoredZones.MonitoredZone}, {@link BasicAlert} and {@link UserAlert}.
